...
public:
	PhysicSystem(ecs::ECSRegistry* p_Registry, uint32_t p_ID, uint32_t p_Priority) : System(p_Registry, p_ID, p_Priority) {}
	~PhysicSystem() {
	...
	{
		auto _RendererComponents = m_registry->GetAllComponents<PhysicComponent>();
